// -----------------------------------------------------------------------
// <copyright file="ErrorLogInterpolatedStringHandler.cs" company="NewSage">
...
public readonly ref struct ErrorLogInterpolatedStringHandler
{
    ...
    public ErrorLogInterpolatedStringHandler(int literalLength, int formattedCount, out bool isEnabled) =>
        _inner = new LogInterpolatedStringHandler(literalLength, formattedCount, LogLevel.Error, out isEnabled);

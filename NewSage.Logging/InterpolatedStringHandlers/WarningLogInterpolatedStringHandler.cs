// -----------------------------------------------------------------------
// <copyright file="WarningLogInterpolatedStringHandler.cs" company="NewSage">
...
public readonly ref struct WarningLogInterpolatedStringHandler
{
    ...
    public WarningLogInterpolatedStringHandler(int literalLength, int formattedCount, out bool isEnabled) =>
        _inner = new LogInterpolatedStringHandler(literalLength, formattedCount, LogLevel.Warning, out isEnabled);

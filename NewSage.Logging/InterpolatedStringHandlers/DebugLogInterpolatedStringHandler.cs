// -----------------------------------------------------------------------
// <copyright file="DebugLogInterpolatedStringHandler.cs" company="NewSage">
...
public readonly ref struct DebugLogInterpolatedStringHandler
{
    ...
    public DebugLogInterpolatedStringHandler(int literalLength, int formattedCount, out bool isEnabled) =>
        _inner = new LogInterpolatedStringHandler(literalLength, formattedCount, LogLevel.Debug, out isEnabled);
